...
export const query = graphql`
  query {
    ...
    process: file(relativePath: { eq: "lets-work-together/bespoke-originals/Image-exports3x4_image_studio_oscardelarenta.png" }) {
      childImageSharp {
        fluid(quality: 100) {
    ...
    consider_3: file(relativePath: { eq: "lets-work-together/bespoke-originals/Image-exports04_bespoke_orignals_consider.png" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    consider_4: file(relativePath: { eq: "lets-work-together/bespoke-originals/Image-exports05_bespoke_orignals_consider.png" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    consider_5: file(relativePath: { eq: "lets-work-together/bespoke-originals/Image-exports06_bespoke_orignals_consider.png" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
